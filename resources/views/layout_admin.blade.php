        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('sachsv.create')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Mới</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('sachsv.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh Sách</p>
                </a>
              </li>
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('sinhvien.create')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Mới</p>
                </a>
              </li>
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('sach.create')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Mới</p>
                </a>
              </li>
